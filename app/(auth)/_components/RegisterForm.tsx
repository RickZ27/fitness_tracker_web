...
const inputStyle = (hasError: boolean) => ({
    ...
    border: hasError ? "1px solid rgba(255,60,60,0.5)" : "1px solid rgba(255,255,255,0.10)",
    color: "#f0f0f2",
});
...
const focusOff = (e: React.FocusEvent<HTMLInputElement>, hasError: boolean) => {
    e.currentTarget.style.borderColor = hasError ? "rgba(255,60,60,0.5)" : "rgba(255,255,255,0.10)";
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{ background: "linear-gradient(160deg, #07100a 0%, #040406 60%)" }}
            >
                {/* Grid bg */}
                <div
                ...
                <div
                    ...
                    style={{
                        ...
                        background: "radial-gradient(circle, rgba(163,255,87,0.09) 0%, transparent 70%)",
                ...
                <div className="relative flex flex-col gap-8">
                    ...
                    >
                        Start Your
                        <br />
                        <span style={{ color: "#a3ff57" }}>Journey.</span>
                    </h2>

                    <p className="max-w-xs text-sm leading-relaxed" style={{ color: "rgba(240,240,242,0.45)" }}>
                        Track workouts, set goals, and watch your body transform — all in one place.
                        Free forever.
                    </p>
                    ...
                    <div className="flex flex-col gap-4">
                        {[
                            "Set weight, body fat & custom goals",
                            "Log workouts with sets, reps & rest",
                            "Track body metrics over time",
                            "Analytics dashboard with trends",
                        ].map((item) => (
                            <div key={item} className="flex items-center gap-3">
                                <span
                                    className="w-5 h-5 rounded-sm flex items-center justify-center shrink-0 text-xs font-black"
                                    style={{
                                ...
                                <span className="text-sm" style={{ color: "rgba(240,240,242,0.55)" }}>{item}</span>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                >
                    ...
                    <p className="text-sm leading-relaxed italic" style={{ color: "rgba(240,240,242,0.6)" }}>
                        &quot;I lost 12kg in 4 months using Fitness Tracker. Seeing the data every day kept
                        me accountable.&quot;
                    </p>
                    <p className="mt-4 text-xs font-semibold tracking-widest uppercase" style={{ color: "rgba(240,240,242,0.25)" }}>
                        — Priya S., 4 month transformation
                    </p>
                </div>
            </div>
                ...
                <div className="w-full max-w-sm mx-auto lg:mx-0">
                    ...
                    <div className="mb-8">
                        ...
                        >
                            Join
                            <br />
                            <span style={{ color: "#a3ff57" }}>Fitness Tracker</span>
                        </h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(submit)} className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input
                                ...
                                onFocus={focusOn}
                                onBlur={(e) => focusOff(e, !!errors.fullName)}
                            />
                            {errors.fullName?.message && (
                                <p className="text-xs" style={{ color: "#ff6b6b" }}>{errors.fullName.message}</p>
                            )}
                        </div>
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            {errors.username?.message && (
                                <p className="text-xs" style={{ color: "#ff6b6b" }}>{errors.username.message}</p>
                            )}
                        </div>
                        ...
                        <p className="text-center text-sm" style={{ color: "rgba(240,240,242,0.4)" }}>
                            ...
                            <Link href="/login" className="font-bold" style={{ color: "#a3ff57" }}>
                                Log in →
                            </Link>
                        </p>
                    </form>
